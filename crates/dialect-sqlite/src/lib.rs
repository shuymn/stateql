...
const PARSE_NOT_IMPLEMENTED: &str = "sqlite parse is not implemented";
const CONNECT_NOT_IMPLEMENTED: &str = "sqlite connect is not implemented";
const GENERATE_DDL_STUB_OP: &str = "GenerateDdlStub";
const TO_SQL_STUB_OP: &str = "ToSqlStub";
const CONNECT_STUB_SQL: &str = "CONNECT sqlite";
